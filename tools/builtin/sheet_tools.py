...
@tool(description="Create a new spreadsheet. Optionally place it in a specific Drive folder. After creation, MUST add the requesting user as full_access collaborator via add_collaborator.", parallel_safe=False)
